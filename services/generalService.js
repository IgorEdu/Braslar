  ...
  static async getAll() {
    try {
      ...
      return await pool.request().query(
        `SELECT NF.CLI, CLI.RASSOC, CLI.RESUMO, CLI.CGC, CASE 
          WHEN SUBSTRING(CLI.CGC,1,10) = '00.000.000' THEN CONCAT('EXP_',NF.CLI)
          ELSE SUBSTRING(CLI.CGC,1,10)
          END AS BASE_CGC, 
        NF.ESTADO AS UF_SIGLA, UF.ESTADO, CLI.REGIAO, NF.NUMERO, NF.EMI AS DT_FATURADO, 
