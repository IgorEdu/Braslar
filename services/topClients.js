  ...
  static async getClients() {
    try {
      ...
      return await pool.request().query(
        `SELECT TOP 10 NF.CLI, CLI.RASSOC, CLI.RESUMO, SUBSTRING(CLI.CGC,1,10) AS CGC, NF.ESTADO, CLI.REGIAO,
    ...
    GROUP BY NF.CLI, CLI.RASSOC, CLI.RESUMO, CLI.CGC, NF.ESTADO, CLI.REGIAO
